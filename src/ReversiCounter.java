...
public class ReversiCounter extends JFrame implements ActionListener{
...
public ReversiCounter()
{
  ...
  playerOne = new SemiProPlayer(COLOR_ONE, "BLACK", center);
   ...
   if(player){
    if(theBoard.hasMove(COLOR_ONE) == false){
     ...
     if(!theBoard.equals(board_copy)){
      ...
      player_two_record++; System.out.print("I");
      game_done = true;
      this.createGame();
      return;     
     }
    ...
    if(theBoard.hasMove(COLOR_TWO) == false){
     ...
     if(!theBoard.equals(board_copy)){
      ...
      player_one_record++; System.out.print("I");
      game_done = true;
      this.createGame();
      return;     
     }
  ...
  if(e.getSource() == play){
   ...
   System.out.println("Player one: " + player_one_record + " wins");
   System.out.println("Player two: " + player_two_record + " wins");
   System.out.println("Player one wins " + ((player_one_record*1.0)/NUMBER_OF_GAMES)*100 + "%");
   playingMultipleGames = false;
  }
 ...
 {
    ReversiCounter game = new ReversiCounter();
    //System.out.println("Player one: " + player_one_record + " wins");
    //System.out.println("Player two: " + player_two_record + " wins");
 }
